...
let inputName = prompt("İsminizi Giriniz");
let myName = document.getElementById("myName").innerHTML = inputName;
...
studentResult=studentResult.toFixed(2)
let textInfo;
...
if (studentResult>=0 && studentResult<=100){
    ...
    if (studentResult>=100) {
        examInfo.innerHTML="AA geçtin"
                 ...
                 examInfo.innerHTML= studentResult +" - BA geçtin   "+ SMILE
        }
        else if (studentResult>=80) {
                examInfo.innerHTML= studentResult +" - BB geçtin   " + SMILE
        }
        else if (studentResult>=75) {
                examInfo.innerHTML=studentResult + " - CB geçtin   " + SMILE
        }
        else if (studentResult>=70) {
                examInfo.innerHTML=studentResult + " - CC geçtin   " + SMILE
        }
        else if (studentResult>=65) {
                examInfo.innerHTML=studentResult + " - DC geçtin   " + SMILE
        }
        else if (studentResult>=60) {
                examInfo.innerHTML=studentResult + " - DD geçtin   " + SMILE
        }
        else if (studentResult>=50) {
                examInfo.innerHTML=studentResult + " - FD geçtin   " + SMILE
        }
        else if (studentResult<=50) {
                examInfo.innerHTML=studentResult + " - FF kaldın.   " + SAD
